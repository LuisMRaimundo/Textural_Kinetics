...
".venv\Scripts\python.exe" -m $($cfg.LaunchModule)
pause
"@
...
function Start-GranularityApp {
    param(
        [string]$VenvPython,
        [string]$ProjectRoot
    )
    $cfg = $script:GranularityConfig
    Write-InstallLog 'Starting Granularity Analyser (desktop GUI)...'
